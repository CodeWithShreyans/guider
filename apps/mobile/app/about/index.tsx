            ...
            <View className="gap-4">
                <View className="mx-4 p-3 mt-4 ios:bg-card bg-card/70 border-border rounded-xl">
                    ...
                    <Text variant="callout" className="pt-1">
                        I'm a software developer, student, and entrepreneur from
                        India.
                    </Text>
                    <Text variant="callout" className="pt-1">
                        While watching a video one day about a how to land a
                        plane, I found it impossible for a layperson to memorise
                        the complex steps.
                    </Text>
                    <Text variant="callout" className="pt-1">
                        So I decided to make a simple app with instant access to
                        all kinds of emergency guides{" "}
                ...
                <View className="flex-row justify-evenly">
                    <View className="mx-4 p-3 mt-4 ios:bg-card bg-card/70 border-border rounded-xl">
                        <Button
                            ...
                            onPress={() => {
                                Linking.openURL(
                                    "https://github.com/CodeWithShreyans/wsidnow"
                                );
                            }}
                        >
                            <GithubIcon
