...
const ContributeForm = () => {
	...
	const [steps, setSteps] = React.useState([{ heading: "", description: "" }]);
						...
						>
							<FormItem>
								<TextField
									...
									onChange={(e) => {
										onChange();
										updateStep(index, "heading", e.nativeEvent.text);
									}}
								...
								<TextField
									...
									onChange={(e) => {
										onChange();
										updateStep(index, "description", e.nativeEvent.text);
									}}
								...
								{steps.length > 1 && (
									...
									>
										<Button className="mt-2" variant="plain">
											<Text>Remove</Text>
										</Button>
									</Alert>
								)}
