...
const buttonVariants = cva("flex-row items-center justify-center gap-2", {
    variants: {
        variant: {
            ...
            destructive:
                "ios:bg-destructive/10 dark:ios:bg-destructive/10 ios:active:bg-destructive/15 bg-destructive/15 dark:bg-destructive/30",
...
const buttonTextVariants = cva("font-medium", {
    variants: {
        variant: {
            ...
            destructive: "ios:text-destructive text-destructive",
